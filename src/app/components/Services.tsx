  ...
  return (
    <div className="py-8 px-4 md:px-12 lg:px-16">
      ...
      <p className="text-lg text-papaya-whip bg-myrtle-green-light rounded bg-opacity-60 p-8 mb-6 max-w-screen-sm justify-center mx-auto">
        At Windrose & Company, we offer a range of services designed to help you achieve your business goals. From software development to technology consulting, innovation, and virtual assistance, we have you covered.
      </p>
